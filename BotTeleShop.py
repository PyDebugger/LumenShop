...
# боту нужно скинуть картинку, которую он сохранит в папку image и отправит в ответ пользователю что картинка сохранена и попросит написать содержимое текста
